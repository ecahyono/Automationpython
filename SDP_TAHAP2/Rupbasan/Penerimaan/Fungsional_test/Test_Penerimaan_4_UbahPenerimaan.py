...
# 	if jumlahidentitas == 2:
		# driver.find_element(By.ID, 'deleteIdentitas-1').click()
	...
	# Log.info('Pengecekan jumlah data identitas yang akan di inputkan, menambah 1 baris status petugas')
...
#     if jumlahpenyerah == 2 :
#         driver.find_element(By.ID, "deleteData-1").click()
#         driver.find_element(By.CSS_SELECTOR, ".el-button--primary").click()

#         driver.find_element(By.ID, "deleteData-0").click()
#         driver.find_element(By.CSS_SELECTOR, ".el-button--primary").click()
...
#     if jumlahsaksi == 2 :
#         driver.find_element(By.ID, "deleteSaksi-1").click()
#         driver.find_element(By.CSS_SELECTOR, ".el-button--primary").click()

#         driver.find_element(By.ID, "deleteSaksi-0").click()
#         driver.find_element(By.CSS_SELECTOR, ".el-button--primary").click()

...
def test_pilihdetailbarang():
	...
	try:
		if inp == '1':
			...
			driver.find_element(By.ID, 'buttonUpdate2') 
			WebDriverWait(driver, 50).until(EC.invisibility_of_element_located((By.XPATH, pathData['Rupelemen']['+barang']['loadubhbrng'])))
			Log.info('Membuka halaman detail barang Nourut'  +inp)
		elif inp == '4':
			driver.find_element(By.ID, 'buttonUpdate3').click()
			WebDriverWait(driver, 50).until(EC.invisibility_of_element_located((By.XPATH, pathData['Rupelemen']['+barang']['loadubhbrng'])))
			Log.info('Membuka halaman detail barang Nourut' + inp)
		elif inp == '5':
			driver.find_element(By.ID, 'buttonUpdate4').click()
			WebDriverWait(driver, 50).until(EC.invisibility_of_element_located((By.XPATH, pathData['Rupelemen']['+barang']['loadubhbrng'])))
			Log.info('Membuka halaman detail barang Nourut' + inp)
		elif (inp == 'N' or inp == 'n'):
			next	
...
def test_PNM_008_9():
	...
	driver.find_element(By.ID,'keteranganFoto0').send_keys(keteranfanfoto1)
...
def test_PNM_008_10():
	...
	driver.find_element(By.ID,'keteranganFoto1').send_keys(keteranfanfoto2)
...
def test_input_8(): #Keadaan Segel Penyita
	...
	driver.find_element(By.ID, 'keadaanSegelPenyita').send_keys(KeadaanSegelPenyita)
...
def test_input_10(): #Merek Dan Kondisi
	...
	driver.find_element(By.ID, 'merekDanKondisi').send_keys(MerekDanKondisi)
...
def test_input_12(): 
	...
	driver.find_element(By.ID, 'volume').send_keys(VolumeCC) #Volume / CC
...
def test_input_dataKendaraan9():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan10():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if SeinBelakang == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan11():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if LampuVariasi == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan12():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if PintuKanan == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan13():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if PintuKiri == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan14():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if BodyBelakang == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan15():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if BumperDepan == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan16():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan17():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if Accu == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan18():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if Speedometer == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan19():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if Jok == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan20():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if AC == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan21():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if AudioSound == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan22():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if KarpetBawah == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan23():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan24():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan25():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if BanSerep == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan26():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if Dongkrak == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan27():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if KunciKunci == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan28():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if LogoTulisan == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan29():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if Mesin == 'Ada':
		...
		pass
@mark.fixture_penerimaan
def test_input_dataKendaraan30():
	if (Golongan == 'KENDARAAN BERMOTOR' or Golongan == 'ANGKUTAN (DARAT/LAUT/UDARA)'):
		if STNK == 'Ada':

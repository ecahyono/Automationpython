...
def ManajemenBlokDanKamar(driver):
    ...
    ActionChains(driver).move_to_element(nav2).perform()
    time.sleep(0.5)
    driver.find_element(By.ID, "Manajemen Blok dan Kamar").click()
...
def ManajemenPenghuniBaru(driver):
    ...
    ActionChains(driver).move_to_element(nav2).perform()
    time.sleep(0.5)
    driver.find_element(By.ID, "Manajemen Penghuni Baru").click()
...
def ManajemenKamar(driver):
    ...
    ActionChains(driver).move_to_element(nav2).perform()
    time.sleep(0.5)
    driver.find_element(By.ID, "Manajemen Kamar").click()

def SuratMutasiBlok(driver):
    nav1 = driver.find_element(By.ID, 'KEA00')
    ActionChains(driver).move_to_element(nav1).perform()
    time.sleep(0.5)
    nav2 = driver.find_element(By.ID, "KEA02")
    ActionChains(driver).move_to_element(nav2).perform()
    time.sleep(0.5)
    driver.find_element(By.ID, "Surat Mutasi Blok/Kamar").click()

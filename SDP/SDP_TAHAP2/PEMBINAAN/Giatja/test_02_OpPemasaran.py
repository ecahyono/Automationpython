...
def test_TC_GIATJA_009():
    ...
    while condition:
        ...
        JenisProdukPemasaran                                    = ['jenisProduk0-opt0']
        JenisProdukPemasaran1                                  = ['jenisProduk1-opt0']
       

        ProdukPemasaran                                         = ['produk0-opt0']
        ProdukPemasaran1                                         = ['produk1-opt0']
        ...
        for i in range(1):
            ...
            jumlahpemasaranFaker                                = random.randint(1,1)

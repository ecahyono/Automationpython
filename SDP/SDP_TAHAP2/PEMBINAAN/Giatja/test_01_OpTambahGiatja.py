...
def test_TC_GIATJA_003():
    ...
    sleep(driver)
    driver.find_element(By.XPATH, "//input[@id=' tanggalAwalKegiatan']").send_keys(tanggalAwalKegiatanFaker)
    ...
    sleep(driver)
    time.sleep(1)
    driver.find_element(By.XPATH, "//input[@id='tanggalAkhirKegiatan']").send_keys(tanggalAkhirKegiatanFaker)
    driver.find_element(By.CSS_SELECTOR, ".mt-6").click()
    Log.info('Input Tanggal Akhir Kegiatan')
    print(tanggalAkhirKegiatanFaker)
    ...
    try:
        WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.ID, "produk0")))
        driver.find_element(By.ID, "produk0").click()

    except: 
        print('Input idJenisProduk')
        driver.find_element(By.ID, "namaProduk").send_keys("NEW TEST WILDAN")

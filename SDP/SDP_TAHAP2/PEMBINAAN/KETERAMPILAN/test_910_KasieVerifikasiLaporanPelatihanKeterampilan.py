...
fh = logging.FileHandler('./Log/Log10KasieVerifikasiLaporanPelatihanKeterampilan.log', mode="w")
...
@pytest.mark.webtest
def test9_SetupOs_KasieVerifikasiLaporanPelatihan():
...
@pytest.mark.webtest
def test_Exit10_KasieVerifikasiLaporanPelatihanKeterampilan():
    sleep(driver)
    attach(data=driver.get_screenshot_as_png())
    quit(driver)

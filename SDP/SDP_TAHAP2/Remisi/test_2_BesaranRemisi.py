...
def test_TC_REM_002_AksesMenu():
    print('Operator mengakses Operator mengakses submenu Besaran Remisi')
    sleep(driver)
...
def test_TC_REM_003_TambahPemberianRemisi():
    ...
    while condition:
        ...
        print('pusat Pusat menambahkan data tim Besaran Remisi')
        sleep(driver)
        ...
        Log.info ('Berhasil mengisi form tambah Besaran Remisi')
...
def test_TC_REM_004_SearchData():
    ...
    print('Pusat Search data index Tahun Besaran Remisi')
    time.sleep(1)
    driver.find_element(By.ID, "column").click()
    time.sleep(0.5)
    ...
    time.sleep(0.5)
    WebDriverWait(driver, 30).until(EC.element_to_be_clickable((By.CSS_SELECTOR, ".text-green-500 path")))
    Log.info ('Berhasil search data Tahun Besaran Remisi')
...
def test_TC_REM_005_HalamanDetail():
    print('Pusat mengakses Halaman Detail Besaran Remisi')
    sleep(driver)
    ...
    Log.info ('Berhasil mengakses halaman detail Besaran Remisi')

@pytest.mark.webtest
def test_TC_REM_006_HalamanEdit():
    print('Pusat mengakses Halaman Edit Besaran Remisi')
    sleep(driver)
    ...
    Log.info ('Berhasil mengakses halaman Edit Besaran Remisi')

@pytest.mark.webtest
def test_TC_REM_007_EditData():
    print('Pusat Mengubah Data Besaran Remisi')
    sleep(driver)
    WebDriverWait(driver, 30).until(EC.element_to_be_clickable((By.ID, "backButton")))
    ...
    Log.info ('Berhasil mengubah data Besaran Remisi')

@pytest.mark.webtest
def test_TC_REM_008_DeleteData():
    print('Pusat Menghapus Data Besaran Remisi')
    sleep(driver)
    ...
    Log.info ('Berhasil menghapus data Besaran Remisi')
